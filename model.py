...
# Try different imports for VGG16 depending on TF version
try:
    ...
    try:
        ...
        print("ERROR: Cannot import VGG16. Make sure TensorFlow is properly installed.")
        import sys
        sys.exit(1)
...
if gpus:
    try:
        ...
        print(f"\n*** TRAINING WILL USE GPU: {gpus} ***\n")
    except RuntimeError as e:
        print(f"Error configuring GPU: {e}")
        print("Training might not use GPU acceleration.")
else:
    print("\n*** WARNING: NO GPU DETECTED - TRAINING WILL BE VERY SLOW ***")
    print("To enable GPU, run the gpu_check.py script for diagnosis.\n")
